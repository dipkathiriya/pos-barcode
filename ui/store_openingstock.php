...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Store Opening Stock</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                        <li class="breadcrumb-item active">Store Opening Stock</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <form id="opning_stock" name="opning_stock" method="post">
                            ...
                            <div class="panel mt-3 mx-3 "> 
                                <div class="row mt-5">     
                                   ...
                                   <div class="mb-3 col-sm-3 mt-4 offset-sm-5" >
                                        <button class="btn btn-primary " type="submit" id="save" name="save">Add Opning Stock</button>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
...
$('#opning_stock').validate({
    ...
    submitHandler: function(form) {
        ...
        $('.stockbody tr').each(function(){
            ...
            store_stock.push(sub_item);
        });
        $.ajax({
            type: "POST",
            url: "getdata.php",
            data: {
                action: "store_opning_stock",
