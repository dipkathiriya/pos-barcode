...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Opning Stock Report</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                        <li class="breadcrumb-item active">Opning Stock Report</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card card-primary card-outline">
                        <form id="stock_report" name="stock_report" method="post">
                            <div class="card-header">
                                <h5 class="m-0">Opning Stock Report</h5>
                            </div>
    ...
    function get_report_data(){
        ...
        if(fromdate !== '' && todate !== ''){
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    action: 'fill_opning_stock_report',
                    fromdate: fromdate,
                    todate: todate
                },
