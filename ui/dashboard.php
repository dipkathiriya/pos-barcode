...
else if ( $_SESSION['role'] ==  $warehouse or $_SESSION['username'] == "") {
...
$select =$conn->prepare("select sum(total) as gt , count(invoice_id) as invoice from tbl_invoice");
$select->execute();
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                ...
                                <a href="#" class="small-box-footer"><i class="fa fa-inr"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <?php
                            $select = $conn->prepare("SELECT order_date , total  FROM tbl_invoice GROUP BY order_date LIMIT 50");
                            $select->execute();
                            $ttl = [];
                            $date = [];
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-hover " id="table_bestsellingproduct">
                                ...
                                <tbody>
                                    <?php
                                    $select = $conn->prepare("select product_id,product_name,rate,sum(qty) as q , sum(saleprice) as total from tbl_invoice_details group by product_id order by sum(qty) DESC LIMIT 10");
                                    $select->execute();
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped table-hover " id="table_recentorder">
                                ...
                                <tbody>
                                    <?php
                                    $select = $conn->prepare("select * from tbl_invoice  order by invoice_id DESC LIMIT 30");
                                    $select->execute();
